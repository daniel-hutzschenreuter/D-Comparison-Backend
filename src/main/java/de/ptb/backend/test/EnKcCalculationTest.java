...
public class EnKcCalculationTest {
    ...
    List<Double> enCriterion = new ArrayList<>(Arrays.asList(0.25,1.13,0.68,0.53,0.01,0.80,0.13,0.70,3.59,1.36,0.64,0.00));
    @Test
    ...
    public void checkKcCalc() throws IOException {
        ...
        assertEquals(this.enCriterion, enValuesResult);
    }
}
